  ...
  return (
    <section className="relative bg-gradient-to-b from-gray-100 to-gray-300 dark:from-gray-900 dark:to-black h-screen w-full p-6 rounded-b-[90px] md:rounded-b-[180px] flex flex-col sm:flex-row justify-center items-center lg:justify-center gap-8 lg:gap-32 -mt-24 sm:-mt-16">
      <Image
        ...
        alt="Hero Image"
        className="h-64 w-auto sm:h-80 md:h-96 lg:h-[28rem] mt-32"
        width={800}
        height={800}
      />
      <div className="flex flex-col justify-center items-center sm:items-start text-center sm:text-left md:mt-32">
        ...
        <TextAnimate
          ...
          as="h1"
          duration={2.2}
          className="text-4xl md:text-5xl lg:text-6xl font-medium text-primary text-pretty max-w-2xl lg:max-w-xl">
